...
function customLoadingConfig() {
    ...
    const config = {
        enable: true,
        image: ()=>{
            return `<svg style="width: 100px;height: 100px;display:inline-block;" version="1.1" id="L9" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
